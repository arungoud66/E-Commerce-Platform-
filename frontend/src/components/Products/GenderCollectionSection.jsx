		...
		<section className='py-16 px-4'>
			<div className='container mx-auto flex flex-col md:flex-row gap-8'>
				...
				<div className='relative flex-1'>
					<img src={womensCollectionImage} alt='womens collection' className='w-full h-[500px] object-cover' />
				...
				{/* Mens Collection */}
				<div className='relative flex-1'>
					<img src={mensCollectionImage} alt='mens collection' className='w-full h-[500px] object-cover' />
					<div className='absolute bottom-8 left-8 bg-white bg-opacity-90 p-4'>
