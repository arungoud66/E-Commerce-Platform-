...
// @desc Get all the products with optional query filters and sorting
// @access Public
router.get('/', async (req, res) => {
	try {
		...
		// Fetch products and apply sorting and limmit
...
// @desc Retrive the latest 8 products - creation date (createdAt)
// @acccess Public
